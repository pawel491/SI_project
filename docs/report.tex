...
\textbf{Random Forest:}
\begin{itemize}
    \item Number of trees: 50, 100
    \item Maximum forest depth: 5
\end{itemize}

\textbf{Support Vector Machine:}
\begin{itemize}
    \item Regularization parameter (C): 0.1, 1, 10
\end{itemize}

\textbf{AdaBoost:}
\begin{itemize}
    \item Number of estimators: 50, 100, 200
    \item Learnign rate: 0.5, 1, 1.5
\end{itemize}

\textbf{Naive Bayes:}
\begin{itemize}
    \item Variance smoothing: $10^{-9}$, $10^{-8}$, $10^{-7}$
\end{itemize}
...
\begin{itemize}
    \item Number of trees: 50, 100
    \item Maximum forest depth: 5
    \item Class weights: \{Healthy: 1, Diseased: 5\}, \{Healthy: 1, Diseased: 10\}, \{Healthy: 1, Diseased: 20\}, \{Healthy: 1, Diseased: 50\}
\end{itemize}
